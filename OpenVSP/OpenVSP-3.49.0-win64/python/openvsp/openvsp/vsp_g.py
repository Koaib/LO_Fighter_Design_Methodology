...
AUX_GEOM_SINGLE_GEAR = _vsp_g.AUX_GEOM_SINGLE_GEAR
...
GEAR_CONFIGURATION_DOWN = _vsp_g.GEAR_CONFIGURATION_DOWN
GEAR_CONFIGURATION_UP = _vsp_g.GEAR_CONFIGURATION_UP
GEAR_CONFIGURATION_UP_AND_DOWN = _vsp_g.GEAR_CONFIGURATION_UP_AND_DOWN
GEAR_CONFIGURATION_INTERMEDIATE = _vsp_g.GEAR_CONFIGURATION_INTERMEDIATE
GEAR_CONFIGURATION_ALL = _vsp_g.GEAR_CONFIGURATION_ALL
NUM_GEAR_CONFIGURATION_MODES = _vsp_g.NUM_GEAR_CONFIGURATION_MODES
GEAR_STOWED_POSITION = _vsp_g.GEAR_STOWED_POSITION
GEAR_MECHANISM = _vsp_g.GEAR_MECHANISM
NUM_GEAR_RETRACT_MODES = _vsp_g.NUM_GEAR_RETRACT_MODES
...
TIRE_NOMINAL_CLEARANCE = _vsp_g.TIRE_NOMINAL_CLEARANCE
TIRE_GROWTH_CLEARANCE = _vsp_g.TIRE_GROWTH_CLEARANCE
TIRE_CLEARANCE = _vsp_g.TIRE_CLEARANCE
NUM_TIRE_CLEARANCE_MODES = _vsp_g.NUM_TIRE_CLEARANCE_MODES
...
class Matrix4d(object):
    ...
    def _print(self, *args):
        ...
        return _vsp_g.Matrix4d__print(self, *args)
    ...
    def const_data(self):
        ...
        return _vsp_g.Matrix4d_const_data(self)
    ...
    def getRotationAxis(self, axis_dir, axis_pnt, angle):
        r"""getRotationAxis(Matrix4d self, vec3d axis_dir, vec3d axis_pnt, double & angle)"""
        return _vsp_g.Matrix4d_getRotationAxis(self, axis_dir, axis_pnt, angle)
